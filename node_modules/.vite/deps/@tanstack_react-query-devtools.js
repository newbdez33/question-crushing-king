...
import {
  ...
  render,
  setupStyleSheet
} from "./chunk-GIAQJ3V5.js";
import {
  onlineManager,
  useQueryClient
} from "./chunk-N5UCNDUV.js";
import {
  require_jsx_runtime
...
// node_modules/.pnpm/@tanstack+react-query-devtools@5.91.2_@tanstack+react-query@5.90.17_react@19.2.3/node_modules/@tanstack/react-query-devtools/build/modern/ReactQueryDevtools.js
  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (this.#Component) {
        ...
        Devtools = lazy(() => import("./CDWEKZTF-R4EXY5IN.js"));
  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (this.#Component) {
        ...
        Devtools = lazy(() => import("./5A54IY5X-G3USHIHQ.js"));
        this.#Component = Devtools;
      }
      setupStyleSheet(this.#styleNonce, this.#shadowDOMTarget);
      return createComponent(Devtools, mergeProps({
...
// node_modules/.pnpm/@tanstack+react-query-devtools@5.91.2_@tanstack+react-query@5.90.17_react@19.2.3/node_modules/@tanstack/react-query-devtools/build/modern/ReactQueryDevtoolsPanel.js
...
// node_modules/.pnpm/@tanstack+react-query-devtools@5.91.2_@tanstack+react-query@5.90.17_react@19.2.3/node_modules/@tanstack/react-query-devtools/build/modern/index.js
